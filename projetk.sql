...
CREATE TABLE public.users_profile (
    id integer NOT NULL,
    "profileImage" character varying(100) NOT NULL,
    user_id integer NOT NULL
);
...
--
-- Name: video_video id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
CREATE INDEX video_video_author_id_7e3e31cd ON public.video_video USING btree (author_id);
...
--
-- Name: video_video video_video_author_id_7e3e31cd_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
